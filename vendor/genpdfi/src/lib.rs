...
impl From<Mm> for Margins {
    fn from(value: Mm) -> Margins {
        Margins::all(value)
    }
}

impl From<f64> for Margins {
    fn from(value: f64) -> Margins {
        Margins::all(Mm::from(value as f32))
    }
}

impl From<f32> for Margins {
    fn from(value: f32) -> Margins {
        Margins::all(Mm::from(value))
    }
}
